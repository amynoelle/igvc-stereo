#ifndef RBFLAG_FILTER_H
#define RBFLAG_FILTER_H
...
class RBflagFilter {
public:
    RBflagFilter(ros::NodeHandle& nh);

    //! Callback function for dynamic reconfigure server.
    void configCallback(igvc_stereo::rbflag_filter_paramsConfig &config, uint32_t level);
    void filterControl();
